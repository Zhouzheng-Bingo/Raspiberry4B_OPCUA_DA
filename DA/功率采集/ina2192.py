...
if __name__=='__main__':
    ...
    with open('ina219.csv','a',newline='') as csvfile:
        ...
        writer.writerow(['name','PSU Voltage (V)','Shunt Voltage (V)','Load Voltage (V)','Power (W)','Current (A)'])
        ...
        # INA219 measure bus voltage on the load side. So PSU voltage = bus_voltage + shunt_voltage
            ...
            writer.writerow(['ina1',(bus_voltage1+shunt_voltage1),(shunt_voltage1),(bus_voltage1),(power1),(current1/1000)])
            writer.writerow(['ina2',(bus_voltage1+shunt_voltage2),(shunt_voltage2),(bus_voltage2),(power2),(current2/1000)])
            writer.writerow(['ina3',(bus_voltage1+shunt_voltage3),(shunt_voltage3),(bus_voltage3),(power3),(current3/1000)])
            writer.writerow(['ina4',(bus_voltage1+shunt_voltage4),(shunt_voltage4),(bus_voltage4),(power4),(current4/1000)])

...
if __name__ == '__main__':
    ...
    try:
        ...
        Line = opcua_client.get_node("ns=2;i=9002")  # XXXX 替换为实际节点ID
        # 获取所有的前后行的OPC UA节点
        lines_before = [opcua_client.get_node(f"ns=2;i={9000 + i}") for i in range(2)]
        lines_after = [opcua_client.get_node(f"ns=2;i={9003 + i}") for i in range(18)]
            ...
            try:
                with open(file_path, 'r') as file:
                    ...
                    for i in range(1, 3):
                        ...
                        lines_before[2 - i].set_value(line_content)

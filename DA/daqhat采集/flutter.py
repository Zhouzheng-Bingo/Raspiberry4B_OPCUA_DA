...
x_voltage = opcua_client.get_node("ns=2;i=19")
y_voltage = opcua_client.get_node("ns=2;i=20")
z_voltage = opcua_client.get_node("ns=2;i=21")
...
def read_and_display_data(hat, num_channels):
    ...
    while True:
        ...
        if samples_read_per_channel > 0:
            ...
            # Set the OPC UA node values
            x_voltage.set_value(read_result.data[index])
            y_voltage.set_value(read_result.data[index + 1])
            z_voltage.set_value(read_result.data[index + 2])
